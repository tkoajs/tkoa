...
import ensureErrorHandler = require('error-inject');
import getType = require('cache-content-type');
import onFinish = require('on-finished');
...
exports = {
    ...
    get(field: { toLowerCase: () => string | number; }): string {
    ...
    set(field: any, val: string | Array<any>): void {
        if (this.headerSent) return;
    ...
    append(field: string, val: string | Array<any>) {
